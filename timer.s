...
;
;    Description:
;		This programme provedes a function to manipulate the timer.
;
;------------------------------------------------------------------------ 
...
Timer_start_delay   STMFD SP!, {R0, R4, R8}
			        ...
			        LDR R4, [SP, #4] ; Get the param, the amount of delay
...
Timer_start_delay1  LDRB R0, [R8, #Timer] 
			        CMP R0, R4
			        BNE Timer_start_delay1
